          ...
          <ul class="nav navbar-nav">
            <li role="presentation" class="dropdown" style='height:50px'>
                ...
                <?php if($loggedInUser){
                    ...
                    <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/estadoTanquesV3.php")echo ' class="active"';?>><a href="/">Y</a></li>
                ...
                if($loggedInUser->group_id==2){ // Gestion?>
                    <li role="presentation" class="dropdown" style='height:50px'>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li<?php if($_SERVER['PHP_SELF']=='/stockTanques.3.php')echo ' class="active"';?>><a href="/stockTanques.3.php">Control de stock de tanques</a></li>
                ...
                <?php } 
                    ...
                    <li role="presentation" class="dropdown" style='height:50px'>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cargaMovistar.php")echo ' class="active"';?>><a href="/cargaMovistar.php"><strike>Carga facturas</strike></a></li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/listaFacturacion.php")echo ' class="active"';?>><a href="/listaFacturacion.php"><strike>Refacturacion</strike></a></li>
                            <li>----------</li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cargaFacturaMovistar.php")echo ' class="active"';?>><a href="/cargaFacturaMovistar.php">Carga CSV Movistar</a></li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/listaFacturacionMovistar.php")echo ' class="active"';?>><a href="/listaFacturacionMovistar.php">Refacturacion 2021</a></li>
                        </ul>
                    </li>
                <?php } 
                    if($loggedInUser->group_id==2){ // Gestion?>
                ...
                <?php } 
                    ...
                    <li role="presentation" class="dropdown" style='height:50px'>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cajasCruzadas.php")echo ' class="active"';?>><a href="/cajasCruzadas.php">Cajas Calden/Setup</a></li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cajasCruzadasGasoil.php")echo ' class="active"';?>><a href="/cajasCruzadasGasoil.php">Cajas Adelantos Gasoil</a></li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cargaMisComprobantes.php")echo ' class="active"';?>><a href="/cargaMisComprobantes.php">Carga Mis Comprobantes AFIP</a></li>
                            
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/controlaDocumentosCompras.php")echo ' class="active"';?>><a href="/controlaDocumentosCompras.php">Controla documentos de compras</a></li>
                            <li>&nbsp;</li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/mayorAdelantosFleteros.php")echo ' class="active"';?>><a href="/mayorAdelantosFleteros.php">Mayor detallado adelantos fleteros</a></li>
                ...
                if($loggedInUser->group_id==2||$loggedInUser->group_id==5){ // MENU ASOCIADOS?>
                    <li role="presentation" class="dropdown" style='height:50px'>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/ABM.php")echo ' class="active"';?>><a href="/sociosAlta.php">Nuevo Asociado</a></li>
                            ...
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cooptransporte.ddns.net/sociosLibrosListado.php")echo ' class="active"';?>><a href="/sociosLibrosListado.php">Lista libros de actas</a></li>
                            <li>   -----------------   </li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cooptransporte.ddns.net/sociosActasAlta.php")echo ' class="active"';?>><a href="/sociosActasAlta.php">Carga acta</a></li>
                            <li>   -----------------   </li>
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/cooptransporte.ddns.net/setupVencimientosChoferes.php")echo ' class="active"';?>><a href="/setupVencimientosChoferes.php">Actualiza vencimientos</a></li>
                        </ul>
                    </li>
                <?php }
                ...
                if($loggedInUser->group_id==2||$loggedInUser->group_id==6||$loggedInUser->group_id==5||$loggedInUser->group_id==7){ // Transporte?>
                    ...
                    <li role="presentation" class="dropdown" style='height:50px'>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li<?php if($_SERVER['PHP_SELF']=="$ypfUrl/ivaPreparaLibros.php")echo ' class="active"';?>><a href="/ivaPreparaLibros.php"><strike>Genera IVA</strike></a></li>
                    ...
                    <li role="presentation" class="dropdown" style='height:50px'>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li<?php if($_SERVER['PHP_SELF']=='/setupCargadora.php')echo ' class="active"';?>><a href="/setupCargadora.php">Resumen anual Cargadora</a></li>
                            <li<?php if($_SERVER['PHP_SELF']=='/setupViajesCargadora.php')echo ' class="active"';?>><a href="/setupViajesCargadora.php">Trabajos cargadora</a></li>                               
