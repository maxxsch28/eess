	...
	<div class="container">
		<div class='row'>
			<div class="col-md-6">
				...
				<input type='hidden' name='buscador' value='turnos'/>
				<fieldset>
					...
					<div class="input-group" id='rop'>
					  <input type='text' name='rangoInicio' id='rangoInicio' class="input-sm form-control" value="<?php echo date("d/m/y", mktime(0, 0, 0, date("m", strtotime("-1 month")), 1, date("Y", strtotime("-1 month"))));?>" data-date-format="dd/mm/yy"  data-plus-as-tab='true'/>
					...
					<div class="form-group col-md-7 col-md-offset-2">
						  ...
						  <label class="checkbox">
							<input type="checkbox" name='factdif' id='factdif' value=1/> Factura por diferencia pendiente
						  </label>
                                            </div>
					...
					<div class="form-group col-md-5 col-md-offset-1">
						<div class="controls">
							<label class="radio">
								<input type="radio" name="idCaja" id="idCaja1" value="" checked>Todas las cajas
							</label>
							<label class="radio">
								<input type="radio" name="idCaja" id="idCaja2" value="1"><span class="label label-warning">PLAYA</span>
							</label>
							<label class="radio">
