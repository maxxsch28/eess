  ...
  <div class="modal-body"> 
    ...
    <p><input type="submit" class="btn btn-primary btn-large" name="activate" id="newfeedform" value="Resend" /></p>
	 ...
	 <? } ?> 
			...
			<div class="clear"></div>
            <p style="margin-top:30px; text-align:center;"><a href="users_register.php">Register</a> / <a href="login.php">Login</a> / <a href="users_forgot-password.php">Olvidó su contraseña?</a> / <a href="<?php echo $websiteUrl; ?>">Home Page</a></p>
