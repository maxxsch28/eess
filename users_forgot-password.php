<?php
	...
	*/
	require_once("include/inicia.php");require_once("include/config.php");
		...
		if(count($errors) == 0)
		{
			...
			else
			{
				...
				else
				{
					...
					$confirm_url = lang("CONFIRM")."\n".$websiteUrl."users_forgot-password.php?confirm=".$userdetails["activationtoken"];
					$deny_url = ("DENY")."\n".$websiteUrl."users_forgot-password.php?deny=".$userdetails["activationtoken"];
...
<input type="submit" class="btn btn-primary" name="new" id="newfeedform" value="Reset Password" />
			...
			<div class="clear"></div>
            <p style="margin-top:30px; text-align:center;"><a href="users_register.php">Sign Up</a> / <a href="login.php">Login</a> / <a href="<?php echo $websiteUrl; ?>">Home Page</a></p>
            <div class="clear"></div>
</body>
</html>
