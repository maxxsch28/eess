...
$sqlZarpazo = "SELECT DISTINCT dbo.ordservi.sucursal_e AS sucos, dbo.ordservi.numero as numos, dbo.ordservi.fecha, dbo.ordservi.importe, dbo.ordservi.reten_ib, dbo.impupagf.sucursal_e, dbo.impupagf.pago, dbo.ordservi.observacio Collate SQL_Latin1_General_CP1253_CI_AI as observacio, dbo.ordservi.numeinter, dbo.pagos.fecha AS fechaorden, dbo.ordservi.proveedor, dbo.ordservi.fletero  , dbo.pagos.detalle Collate SQL_Latin1_General_CP1253_CI_AI as detalle, SUBSTRING(dbo.pagos.detalle, CHARINDEX('-',dbo.pagos.detalle)+1, len(dbo.pagos.detalle)) Collate SQL_Latin1_General_CP1253_CI_AI as nombreFletero FROM dbo.ordservi, dbo.detaorse, dbo.impupagf, dbo.pagos WHERE dbo.impupagf.pago=dbo.pagos.numero AND dbo.ordservi.numero=dbo.detaorse.ordenservi and dbo.ordservi.proveedor IN (1, 321) AND dbo.detaorse.tipoadelan in (2, 3, 25, 24) and dbo.ordservi.numero = dbo.impupagf.numero and dbo.detaorse.sucursal_e = dbo.ordservi.sucursal_e and dbo.pagos.sucursal = dbo.impupagf.sucursal_e AND dbo.impupagf.fletero = dbo.ordservi.fletero and dbo.pagos.fecha>='$rangoInicio' and dbo.pagos.fecha<='$rangoFin 23:59:59' AND totadelant=dbo.impupagf.importe ORDER BY nombreFletero ASC, detalle Desc, sucos, numos, fechaorden;";
