...
$titulo="Lista adelantos de EESS a Fleteros impagos";
?>
<!DOCTYPE html>
<html lang="es">
  <head>
			...
			<div class="col-md-12">
                <form class='form-horizontal'>
                    ...
                    <div class="form-group">
                        <label for='periodo' class="control-label">Órdenes de servicio impagas a la Estación de Servicio: <!--<select name='periodo' id='periodo' sty>
                            <?php 
                            ...
                            <!--<select name='filtroTipoViaje' id='filtroTipoViaje' class='btn btn-danger'>
                                <option value='0' selected="selected">Todos los fleteros</option>
                                <option value='1'>Solo socios</option>
                                <option value='1'>Solo externos</option>
                                </select>-->
				...
				<table class='table table-striped table-condensed' id='comisionesSocios'>
					<thead><tr><th class='nombre no2'>Fletero</th>
					<th >Adelanto</th>
					<th >Importe</th>
					<th >Pérdida</th>
                                      </tr></thead>
