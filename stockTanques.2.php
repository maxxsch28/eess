      ...
      <div class="container">
          ...
          <div class="col-md-7 hidden-print">
            <ul class="nav nav-tabs" role="tablist" id="myTab" style='height:3.1em;'>
              <li>
                <form class='form-horizontal small'><select name='periodo' id='periodo'>
                <?php
              ...
              <?php foreach($tanque as $id => $detalleTanque){
                echo "<li role='presentation' class='small'><a href='#tq$id' aria-controls='tq$id' role='tab' data-toggle='tab' class='small alert alert-{$classArticulo[$detalleTanque['idArticulo']]}'>".$articulo[$detalleTanque['idArticulo']]['descripcion']."</a></li>";
              }?>
            </ul>
            ...
            <?php 
              ...
              foreach($tanque as $id => $detalleTanque) {
                echo "<div role='tabpanel' class='tab-pane' id='$id'></div>";
              }
              ?>
            </div>
          </div>
...
$(document).ready(function() {
  function actualiza(){
    ...
    $.post('func/listaStockTanquesTabs.2.php', { que:'resumen', mes: $('#periodo').val(), origen: '<?php echo $origen;?>' }, function(data) {
      $('#resumen').html(data);
      /*
