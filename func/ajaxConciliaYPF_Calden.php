...
$tabla = "";$a=0;$q=0;
echo "<tbody>";
while($rowCalden = odbc_fetch_array($stmt)){
  ...
  if(trim($rowCalden['Tipo'])=='OP'&&$rowCalden['PagoEfectivo']==0){
    ...
    if($rowCalden['id']==13139){
      fb($rowCalden);print_r($rowCalden);
    }
