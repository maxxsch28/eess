...
$titulo="Libro Diario Transporte";
$changelog = "0.1: Intenta encontrar desbalanceos";
  ...
  $(document).ready(function() {
    ...
    $('#nuevaOP').submit(function() {
      var opcionesTransporte= {
        ...
        url:       'func/ajaxLibroDiarioTransporte.php',         // override for form's 'action' attribute 
